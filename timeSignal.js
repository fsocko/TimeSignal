...
exports.evaluatePip = function(today, intervals) {
  ...
  if(lastPipDate != null) {
    console.log(today.getTime() - lastPipDate.getTime);
  }
  ...
  //isLastPipMoreThan5 : pip sound is 5s, do not allow pips to overlap.
    ...
    else if(lastPipDate != null && Boolean((today.getTime() - lastPipDate.getTime()) < 5000)){
      console.log("Time too short");
      return false;
    }
    

  //Is seconds +5 the same as doc.pipIntervalS?
